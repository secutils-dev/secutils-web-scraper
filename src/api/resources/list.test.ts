  ...
  assert.strictEqual(
    ...
    JSON.stringify({
      ...
      scripts: [
        ...
        { digest: '6e11c72f7cf6bc383152dd16ddd5903aba6bb1c99d6b6639a4bb0b838185fa92', size: 8 },
        {
          url: 'data:text/javascript;base64,[REDACTED]',
          digest: 'cb86bcc6aefcf05fcf5e888fde6bceba2641673b7484e4ecfcb901fbc53bb5af',
          size: 48,
        },
        {
          url: 'https://secutils.dev/weird-script.js',
          digest: 'a9cf14e70f4640f8e2e9a9742c70d903ab145e32e1693d1f9c389550aec373c6',
          size: 23,
        },
        {
          url: 'blob:[REDACTED]',
          digest: 'e48b3488eae9d0e229cbe34f48e40d8aaf48f90561d7b4f8839d11315511848f',
          size: 8,
        },
      ],
      styles: [
        ...
        },
        {
          ...
          digest: '718f9d008b611fbf592cf44a9155efa3c9ffdc6c220dcd7f4299f2b1e4242096',
          size: 45,
        },
        {
          url: 'blob:[REDACTED]',
          digest: '5b5e7029fdc58ffc4970ddd785f6946e57040dc383a9d6a4b4cd46fb6059515a',
          size: 17,
        },
        { digest: '678e77d012a42a2dd2c117bd49bc203e0bd82fad960a5d861ccc8f491bd262d2', size: 19 },
      ],
    }),
  );
